...
To test the full pipeline you'll need API tokens (Jira, GitHub, AI provider), but many changes can be developed and tested without them.
...
Be respectful and constructive. We're all here to build useful tools for engineers.
